      ...
      child: Row(
        ...
        children: [
          ...
          Tooltip(
            ...
            child: TextButton(
              onPressed: () =>
                  ...
                  ref.read(todoListFilter.notifier).setFilter(TodoListFilter.all),
              style: ButtonStyle(
          ...
          Tooltip(
            ...
            child: TextButton(
              onPressed: () => ref.read(todoListFilter.notifier).setFilter(TodoListFilter.active),
              style: ButtonStyle(
                visualDensity: VisualDensity.compact,
          ...
          Tooltip(
            ...
            child: TextButton(
              onPressed: () => ref.read(todoListFilter.notifier).setFilter(TodoListFilter.completed),
              style: ButtonStyle(
                visualDensity: VisualDensity.compact,
                foregroundColor: WidgetStateProperty.all(
