...
@RoutePage()
class TypingEffectPage extends StatefulWidget {
  const TypingEffectPage({super.key});

  @override
  TypingEffectPageState createState() => TypingEffectPageState();
}

class TypingEffectPageState extends State<TypingEffectPage> {
